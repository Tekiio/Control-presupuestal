 ...
 */
/**
* @name FB - Load to ctrl de ppto -CS 
* @version 1.0
...
define(['N/url'],
    ...
    function (url) {
        ...
        function generateTraslados(objGenerate, fileId) {
            try {
                console.log({ title: 'Parametros', details: objGenerate, fileId });
                ...
                console.error({ title: 'Error generateTraslados:', details: e });
            }
        }
        ...
        function reset() {
            try {
                ...
                console.error({ title: 'Error reset', details: e });
            }
        }
        /**
        ...
        return {
            pageInit: pageInit,
            generateTraslados: generateTraslados,
            reset: reset
